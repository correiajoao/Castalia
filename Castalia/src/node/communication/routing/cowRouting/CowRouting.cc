...
#include "CowRouting.h"

Define_Module(CowRouting);
 ...
 */
void CowRouting::fromApplicationLayer(cPacket * pkt, const char *destination)
{
	CowRoutingPacket *netPacket = new CowRoutingPacket("CowRouting packet", NETWORK_LAYER_PACKET);
 ...
 */
void CowRouting::fromMacLayer(cPacket * pkt, int srcMacAddress, double rssi, double lqi)
{
